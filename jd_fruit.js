...
let shareCodes = [
  ...
  "179aabf81fd545e582f06e37ffdeaae8@3913410e8a7b406e9ceabf8432e6b1ef@083ac568abee485eb8c48b5976c8c778@f1b59579593e4e5f8ae5d11291f6bbd6@c488afb8bc4d4fe6ae1a4f5693a66754@7678937abc6c40098cefd7a5c753c699",
...
async function receiveFriendInvite() {
  ...
  // console.log(`开始接受179aabf81fd545e582f06e37ffdeaae8的邀请\n`)
  // await inviteFriend('179aabf81fd545e582f06e37ffdeaae8');
...
function readShareCode() {
  return new Promise(async (resolve) => {
    $.get({ url: `http://transfer`, timeout: 10000 }, (err, resp, data) => {
      try {
        if (err) {
          console.log(JSON.stringify(err));
