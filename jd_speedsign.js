...
[task_local]
#京东极速版
21 3,8,13 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js, tag=京东极速版, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "21 3,8,13 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js,tag=京东极速版

===============Surge=================
京东极速版 = type=cron,cronexp="21 3,8,13 * * *",wake-system=1,timeout=33600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js

============小火箭=========
京东极速版 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js, cronexpr="21 3,8,13 * * *", timeout=33600, enable=true
*/
const $ = new Env('京东极速版');
...
async function signInit() {
  return new Promise(resolve => {
    $.get(taskUrl('speedSignInit', {
      ...
      "kernelPlatform": "RN",
      "inviterId":"P4pO91wgMAxsA2f2H8ix5A=="
    }), async (err, resp, data) => {
      try {
        if (err) {
...
function invite() {
  let t = +new Date()
  let inviterIdArr = [
    "P4pO91wgMAxsA2f2H8ix5A==",
    "4f4AkDwHK1UraZjolZtZtYLGdjZBgZkEEnjHtcux9Wg=",
    "Z5h48+mYsasB4f7bDUk7dA==",
    "D5DojghZIUXnndVCy4VTCw==",
    "7ocdW2kVWK0TFwEWjdbA+w==",
  ]
  let inviterId = inviterIdArr[Math.floor((Math.random() * inviterIdArr.length))]
  let options = {
