  ...
  switch (stop) {
    case 0:
      await Promise.all([
        ...
        // JingRongDoll(stop, 'JRDoll', '京东金融-签壹', ''),
        // JingRongDoll(stop, 'JRThreeDoll', '京东金融-签叁', ''),
        // JingRongDoll(stop, 'JRFourDoll', '京东金融-签肆', ''),
        // JingRongDoll(stop, 'JRFiveDoll', '京东金融-签伍', '')
      ]);
      await Promise.all([
        // JDUserSignPre(stop, 'JDUndies', '京东商城-内衣', ''), //京东内衣馆
        // JDUserSignPre(stop, 'JDCard', '京东商城-卡包', ''), //京东卡包
        // JDUserSignPre(stop, 'JDCustomized', '京东商城-定制', ''), //京东定制
        // JDUserSignPre(stop, 'JDaccompany', '京东商城-陪伴', ''), //京东陪伴
        ...
        // JDUserSignPre(stop, 'ReceiveJD', '京东商城-领豆', ''), //京东-领京豆
        JingRongDoll(stop, 'JTDouble', '京东金贴-双签', ''), //京东金融 金贴双签
        // JingRongDoll(stop, 'XJDouble', '金融现金-双签', '', '', '', '', 'xianjin') //京东金融 现金双签
      ]);
      await Promise.all([
        // JDUserSignPre(stop, 'JDStory', '京东失眠-补贴', ''), //失眠补贴
        // JDUserSignPre(stop, 'JDPhone', '京东手机-小时', ''), //手机小时达
        // JDUserSignPre(stop, 'JDEsports', '京东商城-电竞', ''), //京东电竞
        // JDUserSignPre(stop, 'JDClothing', '京东商城-服饰', ''), //京东服饰
        // JDUserSignPre(stop, 'JDSuitcase', '京东商城-箱包', ''), //京东箱包馆
        // JDUserSignPre(stop, 'JDSchool', '京东商城-校园', ''), //京东校园
        // JDUserSignPre(stop, 'JDHealth', '京东商城-健康', ''), //京东健康
    ...
    default:
      ...
      // await JingRongDoll(Wait(stop), 'JRThreeDoll', '京东金融-签叁', '');
      // await JingRongDoll(Wait(stop), 'JRFourDoll', '京东金融-签肆', '');
      // await JingRongDoll(Wait(stop), 'JRFiveDoll', '京东金融-签伍', '');
      // await JingRongDoll(Wait(stop), 'JRDoll', '京东金融-签壹', '');
      // await JingRongDoll(Wait(stop), 'XJDouble', '金融现金-双签', '', '', '', '', 'xianjin'); //京东金融 现金双签
      await JingRongDoll(Wait(stop), 'JTDouble', '京东金贴-双签', ''); //京东金融 金贴双签
      // await JDUserSignPre(Wait(stop), 'JDStory', '京东失眠-补贴', ''); //失眠补贴
      // await JDUserSignPre(Wait(stop), 'JDPhone', '京东手机-小时', ''); //手机小时达
      // await JDUserSignPre(Wait(stop), 'JDCard', '京东商城-卡包', ''); //京东卡包
      // await JDUserSignPre(Wait(stop), 'JDUndies', '京东商城-内衣', ''); //京东内衣馆
      // await JDUserSignPre(Wait(stop), 'JDEsports', '京东商城-电竞', ''); //京东电竞
      // await JDUserSignPre(Wait(stop), 'JDCustomized', '京东商城-定制', ''); //京东定制
      // await JDUserSignPre(Wait(stop), 'JDSuitcase', '京东商城-箱包', ''); //京东箱包馆
      // await JDUserSignPre(Wait(stop), 'JDClothing', '京东商城-服饰', ''); //京东服饰
      // await JDUserSignPre(Wait(stop), 'JDSchool', '京东商城-校园', ''); //京东校园 
      // await JDUserSignPre(Wait(stop), 'JDHealth', '京东商城-健康', ''); //京东健康
      // await JDUserSignPre(Wait(stop), 'JDShoes', '京东商城-鞋靴', ''); //京东鞋靴
      // await JDUserSignPre(Wait(stop), 'JDChild', '京东商城-童装', ''); //京东童装馆
      // await JDUserSignPre(Wait(stop), 'JDBaby', '京东商城-母婴', ''); //京东母婴馆
      // await JDUserSignPre(Wait(stop), 'JD3C', '京东商城-数码', ''); //京东数码电器馆
      // await JDUserSignPre(Wait(stop), 'JDWomen', '京东商城-女装', ''); //京东女装馆
      // await JDUserSignPre(Wait(stop), 'JDBook', '京东商城-图书', ''); //京东图书
      // await JDUserSignPre(Wait(stop), 'JDShand', '京东拍拍-二手', ''); //京东拍拍二手
      // await JDUserSignPre(Wait(stop), 'JDMakeup', '京东商城-美妆', ''); //京东美妆馆
      // await JDUserSignPre(Wait(stop), 'JDVege', '京东商城-菜场', ''); //京东菜场
      // await JDUserSignPre(Wait(stop), 'JDaccompany', '京东商城-陪伴', ''); //京东陪伴
      // await JDUserSignPre(Wait(stop), 'JDLive', '京东智能-生活', ''); //京东智能生活
      // await JDUserSignPre(Wait(stop), 'JDClean', '京东商城-清洁', ''); //京东清洁馆
      // await JDUserSignPre(Wait(stop), 'JDCare', '京东商城-个护', ''); //京东个人护理馆
      // await JDUserSignPre(Wait(stop), 'JDJiaDian', '京东商城-家电', ''); // 京东小家电馆
      // await JDUserSignPre(Wait(stop), 'ReceiveJD', '京东商城-领豆', ''); //京东-领京豆
      // await JDUserSignPre(Wait(stop), 'JDJewels', '京东商城-珠宝', ''); //京东珠宝馆
